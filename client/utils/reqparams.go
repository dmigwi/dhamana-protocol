...
var (
	...
	contractMethods = map[Method][]ParamType{
		...
		//			CouponDate: 0 => Not-Supportted
		// 			CouponDate: 1 => Hourly
		// 			CouponDate: 2 => Daily
		// 			CouponDate: 3 => Weekly
		// 			CouponDate: 4 => Every-Forty-Night
		// 			CouponDate: 5 => Monthly
		// 			CouponDate: 6 => Quarterly
		// 			CouponDate: 7 => Yearly
		// 			CouponDate: 8 => Bi-Anually
		// 			CouponDate: 9 => Every-3-Years
		// 			CouponDate: 10 => Every-4-Years
		// 			CouponDate: 11 => Every-5-Years ..e.t.c.
